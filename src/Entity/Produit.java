...
public class Produit {
   ...
   private int valider;
    ...
    public Produit(int id, String nom, String description, float prix, int qantite, int promotion, String marque, int nbvente, int nbPointBase, Blob image, UploadedFile uploadedFile, String urlImage, int valider, User user, Categorie categorie_id) {
        this.id = id;
        this.nom = nom;
