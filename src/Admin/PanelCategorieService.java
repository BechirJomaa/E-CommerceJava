 ...
 * @author Dridi
 */
public class PanelCategorieService extends javax.swing.JPanel {

    /**
     * Creates new form PanelCategorieService
     */
    private List<CategorieService> categories = new ArrayList<>();
    private final List<JLabel> lId = new ArrayList<>();
    ...
    public PanelCategorieService() {
        initComponents();
        categories = new CategorieServiceDao().findAll();
        loadCategories();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Liste des categories services");
        add(jLabel4);
        jLabel4.setBounds(300, 0, 310, 40);
        ...
        add(jLabel3);
        jLabel3.setBounds(360, 60, 90, 14);
        ...
        add(jLabel5);
        jLabel5.setBounds(210, 60, 90, 14);
        ...
        add(btnAjouter);
        btnAjouter.setBounds(560, 40, 69, 23);
    ...
    private void loadCategories() {
        ...
        if (categories.size() > 0) {
            ...
            for (int i = 0; i < categories.size(); i++) {
                ...
                //Ajout de l'image
                CategorieService p = new CategorieServiceDao().findbyid(categories.get(i).getId());
                String imagePath = "src\\com\\images\\" + p.getDescription() + ".png";
                ImageIcon icon1 = new ImageIcon(new ImageIcon(imagePath).getImage().
                        getScaledInstance(80, 70, Image.SCALE_DEFAULT));
                //Ajout du nom du produit
                lNom.add(new JLabel(p.getId()));
                add(lNom.get(i));
                lNom.get(i).setBounds(x + 50, y + 20, 90, 30);
                //Ajout du nom du produit
                lDescription.add(new JLabel(p.getId()));
...
//                lDetails.get(i).setBounds(x + 330, y + 20, 60, 30);
                ...
                add(lDelete.get(i));
                lDelete.get(i).setBounds(x + 330, y + 20, 60, 30);
                ...
                add(lModif.get(i));
                lModif.get(i).setBounds(x + 390, y + 20, 20, 30);
                //Ajout du separateur
...
//            lModif.get(j).addMouseListener(new java.awt.event.MouseAdapter() {
//                @Override
//                public void mouseClicked(java.awt.event.MouseEvent evt) {
//                    deleteMouseClicked(evt, j);
//                }
...
//            });
    ...
    private void deleteMouseClicked(MouseEvent evt, int i) {
        ...
        new CategorieServiceDao().removeCategorieServiceById(categories.get(i).getId());
        categories.remove(i);
