 ...
 * @author gafsi
 */
public class DialogueModifierProduit extends javax.swing.JDialog {
    ...
    public DialogueModifierProduit(java.awt.Frame parent, boolean modal,int produitId) {
        super(parent, modal);
        initComponents();
        ...
        tfQuantite.setText(""+produit.getQantite());
        ...
        cbCategorie.setSelectedItem(produit.getCategorie_id().getNom());
    ...
    private void btnModifierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifierActionPerformed
        ...
        produit.setPromotion(Integer.parseInt(tfPromotion.getText()));
        produit.setMarque(tfMarque.getText());
        produit.setQantite(Integer.parseInt(tfQuantite.getText()));
        produit.setCategorie_id(cat.findcategorieByNom(categorie));
        produit.setUrlImage(tfImage.getText());  
       if( new ProduitDAO().modifier(produit)==true)
        new DialogueOk(null, true, "Produit Modifier avec Succées").setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogueModifierProduit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogueModifierProduit dialog = new DialogueModifierProduit(new javax.swing.JFrame(), true,produit.getId());
